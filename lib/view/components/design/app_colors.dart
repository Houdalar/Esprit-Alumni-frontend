...
class AppColors {
  ...
  static const Color primaryColorDark = Color(0xFFA11717);
  static const Color redColor = Color.fromARGB(255, 153, 28, 28);
  ...
  static const Color converBackgroundClr = Color.fromARGB(255, 255, 247, 247);
  static const Color lightGray = Color.fromARGB(255, 240, 240, 240);
  static const Color darkGray = Color(0xFF77747C);
  static const gradientColor = LinearGradient(
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
      colors: [Color(0xFFE94237), Color(0xFF660E0E)]);

  static const gradientBackground = LinearGradient(
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
      colors: [Color(0xFFFF4336), Color(0xFF660E0E)]);
}
