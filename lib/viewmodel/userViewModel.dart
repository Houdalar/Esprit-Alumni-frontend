...
class UserViewModel extends ChangeNotifier {
  ...
  UserViewModel._({required this.context});

  factory UserViewModel.of(BuildContext context) =>
      UserViewModel._(context: context);
  ...
  static UserViewModel fromBuildContext(BuildContext context) {
    return context.read<UserViewModel>();
  }
}
